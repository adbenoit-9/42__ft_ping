...
/*   Updated: 2022/07/14 16:15:11 by adbenoit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	char *msg_err[] = {EPERM_MSG, ENOENT_MSG, ESRCH_MSG, EINTR_MSG, BADAF_MSG,
		ENXIO_MSG, E2BIG_MSG, NONAME_MSG, EBADF_MSG, ECHILD_MSG, EAGAIN_MSG,
		ENOMEM_MSG, EACCES_MSG, EFAULT_MSG, ENOTBLK_MSG, EBUSY_MSG, EEXIST_MSG,
		...
		EROFS_MSG, EMLINK_MSG, EPIPE_MSG, EDOM_MSG, ERANGE_MSG, EDEADLK_MSG,
		ENAMETOOLONG_MSG, ENOLCK_MSG, ENOSYS_MSG, ENOTEMPTY_MSG, ELOOP_MSG,
		EWOULDBLOCK_MSG, ENOMSG_MSG, EIDRM_MSG, ECHRNG_MSG, EL2NSYNC_MSG,
		EL3HLT_MSG, EL3RST_MSG, ELNRNG_MSG, EUNATCH_MSG, ENOCSI_MSG, EL2HLT_MSG,
		EBADE_MSG, EBADR_MSG, EXFULL_MSG, ENOANO_MSG, EBADRQC_MSG, EBADSLT_MSG,
		EDEADLOCK_MSG, EBFONT_MSG, ENOSTR_MSG, ENODATA_MSG, ETIME_MSG, ENOSR_MSG,
		ENONET_MSG, ENOPKG_MSG, EREMOTE_MSG, ENOLINK_MSG, EADV_MSG, ESRMNT_MSG,
		ECOMM_MSG, EPROTO_MSG, EMULTIHOP_MSG, EDOTDOT_MSG, EBADMSG_MSG, EOVERFLOW_MSG,
		ENOTUNIQ_MSG, EBADFD_MSG, EREMCHG_MSG, ELIBACC_MSG, ELIBBAD_MSG, ELIBSCN_MSG,
		ELIBMAX_MSG, ELIBEXEC_MSG, EILSEQ_MSG, ERESTART_MSG, ESTRPIPE_MSG, EUSERS_MSG,
		ENOTSOCK_MSG, EDESTADDRREQ_MSG, EMSGSIZE_MSG, EPROTOTYPE_MSG, ENOPROTOOPT_MSG,
		EPROTONOSUPPORT_MSG, ESOCKTNOSUPPORT_MSG, EOPNOTSUPP_MSG, EPFNOSUPPORT_MSG,
		EAFNOSUPPORT_MSG, EADDRINUSE_MSG, EADDRNOTAVAIL_MSG, ENETDOWN_MSG,
		ENETUNREACH_MSG, ENETRESET_MSG, ECONNABORTED_MSG, ECONNRESET_MSG, ENOBUFS_MSG,
		EISCONN_MSG, ENOTCONN_MSG, ESHUTDOWN_MSG, ETOOMANYREFS_MSG, ETIMEDOUT_MSG,
		ECONNREFUSED_MSG, EHOSTDOWN_MSG, EHOSTUNREACH_MSG, EALREADY_MSG, EINPROGRESS_MSG,
		ESTALE_MSG, EUCLEAN_MSG, ENOTNAM_MSG, ENAVAIL_MSG, EISNAM_MSG, EREMOTEIO_MSG};
